...
import {
  LayoutDashboard, KanbanSquare, Target, Trophy, Package, Building2, Users,
    ...
    <div className="flex h-screen" style={{ background: "var(--paper)" }}>
      <aside className="w-56 shrink-0 flex flex-col py-4 px-2 overflow-y-auto" style={{ background: "var(--ink-950)" }}>
        ...
        {canViewOrgChart(user) && (
          <div className="mb-4">
            <div className="px-3 mb-1.5 text-[10px] font-semibold tracking-wider uppercase" style={{ color: "var(--ink-500)" }}>Team</div>
            ...
            >
              <GitBranch size={15} strokeWidth={2} /> Org Chart
            </NavLink>
          </div>
        )}
        ...
        <header className="h-13 shrink-0 flex items-center justify-between px-5 border-b" style={{ borderColor: "var(--ink-100)", background: "white", height: "52px" }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              {menuOpen && (
                <div className="absolute right-0 top-10 w-52 rounded-lg border shadow-lg bg-white overflow-hidden z-20" style={{ borderColor: "var(--ink-100)" }}>
                  <div className="px-3 py-2.5 border-b" style={{ borderColor: "var(--ink-100)" }}>
                    ...
                    <div className="text-[10px] mt-0.5 font-semibold" style={{ color: "var(--ledger-600)" }}>{roleLabel(user?.orgRole)}</div>
                  </div>
