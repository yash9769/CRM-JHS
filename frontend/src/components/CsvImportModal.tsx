...
> = {
  opportunities: {
    ...
    fields: [
      ...
      { key: "expectedDealValue", label: "Proposal Value", required: true, synonyms: ["proposal value", "proposal sent value", "proposal amount", "proposal", "expected opportunity value", "expected deal value", "opportunity value", "deal value", "amount", "value", "revenue", "deal amount", "opp value"] },
      { key: "actualDealValue", label: "Actual Opportunity Value", synonyms: ["actual opportunity value", "topline value", "actual deal value", "actual value", "agreed value"] },
      { key: "bottomLineCost", label: "Cost Incurred to Company", synonyms: ["cost incurred to company", "cost incurred", "internal cost", "bottom line cost", "cost", "delivery cost", "project cost"] },
      { key: "opportunityStage", label: "Opportunity Stage", synonyms: ["opportunity stage", "opp stage", "stage", "status"] },
      { key: "opportunityType", label: "Opportunity Type", synonyms: ["opportunity type", "opp type", "type", "business type"] },
      ...
      { key: "createdDate", label: "Created Date", synonyms: ["created date", "opportunity created date", "created at", "date created", "creation date"] },
      { key: "closeDate", label: "Close Date", synonyms: ["close date", "opportunity close date", "expected close date", "target close date", "expected close"] },
      { key: "loe", label: "Letter of Engagement (LOE)", synonyms: ["letter of engagement (loe)", "letter of engagement", "loe", "loe reference", "loe value", "engagement letter"] },
      { key: "poNumber", label: "PO Number", synonyms: ["po number", "po #", "purchase order number", "purchase order"] },
      { key: "poValue", label: "PO Value", synonyms: ["po value", "purchase order value", "agreed po value"] },
      { key: "remarks", label: "Remarks", synonyms: ["remarks", "notes", "description", "details", "comments"] },
    ],
  },
  accounts: {
