...
> = {
  opportunities: {
    ...
    fields: [
      ...
      { key: "expectedDealValue", label: "Expected Deal Value", required: true, synonyms: ["expected deal value", "expected value", "opportunity value", "deal value", "amount", "value", "revenue", "deal amount", "opp value"] },
      { key: "actualDealValue", label: "Actual Deal Value", synonyms: ["actual deal value", "actual value", "closed value", "agreed value"] },
