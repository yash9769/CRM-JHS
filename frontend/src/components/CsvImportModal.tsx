...
> = {
  opportunities: {
    ...
    fields: [
      ...
      { key: "actualDealValue", label: "Actual Opportunity Value", synonyms: ["actual deal value", "actual value", "closed value", "agreed value"] },
      { key: "bottomLineCost", label: "Bottom Line Cost", synonyms: ["bottom line cost", "cost", "delivery cost", "project cost"] },
