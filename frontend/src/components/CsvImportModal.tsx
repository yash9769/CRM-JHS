...
> = {
  opportunities: {
    ...
    fields: [
      ...
      { key: "expectedDealValue", label: "Expected Opportunity Value", required: true, synonyms: ["expected deal value", "expected value", "opportunity value", "deal value", "amount", "value", "revenue", "deal amount", "opp value"] },
      { key: "actualDealValue", label: "Actual Opportunity Value", synonyms: ["actual deal value", "actual value", "topline value", "agreed value"] },
      { key: "bottomLineCost", label: "Bottom Line Cost", synonyms: ["bottom line cost", "cost incurred to company", "cost", "delivery cost", "project cost"] },
      ...
      { key: "loe", label: "Letter of Engagement (LOE)", synonyms: ["loe", "letter of engagement", "loe reference", "loe value"] },
