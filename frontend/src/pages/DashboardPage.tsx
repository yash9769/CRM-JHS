...
import { TrendingUp, Target, Handshake, Trophy, Percent, Wallet, Timer, CalendarClock, FileText, Flame } from "lucide-react";
      ...
      {action && (
        <div className="px-8 pb-6">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-3 mb-6">
            <ActionTile icon={CalendarClock} label="Deals Closing This Week" value={action.todaysWork.dealsClosingThisWeek} url="/pipeline" />
